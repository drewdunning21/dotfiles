...
# source .ohmyzsh/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh

eval $(thefuck --alias)
alias fucking="sudo"
alias yeet="rm"
alias docs="cd ~/Documents"
alias xpt="cd ~/Documents/xploit/xploit-tools"
alias vultr="cd ~/Documents/scripts/vultr"
# alias nvim="$HOME/AppImages/nvim.appimage2"
alias lect="sshpass -p Wuq#j4OD ssh amd10@lectura.cs.arizona.edu"
alias mars='java -jar ~/Mars4_5.jar'
alias howp='how2 -l python'
alias howj='how2 -l java'
alias howm='how2 -l mips'
alias src='source ~/.zshrc'
alias gitu='git add .;git commit -m "auto update";git push origin master'
alias logi='java -jar ~/logisim-generic-2.7.1.jar'
alias tmuxt='sh ~/.tmux/scripts/template'
